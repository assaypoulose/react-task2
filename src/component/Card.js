...
function Card(props) {
    ...
    return (
    <div className="card col-md-3 col-5 m-2 shadow-lg d-inline-block">
        <img className="card-img-top" src={imgdata[props.items.id]} alt="banner none" style={{ width: '100%', height: '300px', objectFit: 'cover' }}/>
        ...
        <div className="card-body">
            ...
            <p className="card-text"><span className='text-decoration-line-through text-muted'>{props.items.price}</span>
                ...
                <p className="card-text">{props.items.review}</p>
